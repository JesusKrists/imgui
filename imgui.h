...
namespace ImGui
{
    ...
    IMGUI_API bool          TreeNodeEx_IconText(ImTextureID textureID, const char* label, ImGuiTreeNodeFlags flags);
    IMGUI_API bool          TreeNodeEx_IconText(ImTextureID closeTextureID, ImTextureID openTextureID, const char* label, ImGuiTreeNodeFlags flags);
